...
CREATE TABLE IF NOT EXISTS `oa_active` (
  ...
  `status` tinyint(1) NOT NULL COMMENT '图片状态：0启用，-2删除',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `oa_apps` (
  ...
  `app_id` int(10) NOT NULL COMMENT '公司id',
...
CREATE TABLE IF NOT EXISTS `oa_case` (
  ...
  `time` int(10) unsigned NOT NULL COMMENT '创建时间',
  `status` tinyint(1) NOT NULL COMMENT '0正常-2删除',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `oa_users` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '0正常-2删除',
...
(3, 2, 1, 'shejishi1', '设计师1', 'e10adc3949ba59abbe56e057f20f883e', 0, NULL, 0, NULL, NULL, NULL, 0, 0, 1, NULL);
