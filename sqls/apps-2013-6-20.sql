...
(1, 2, NULL, '49820', '20130619/51c161cac110e.mp3'),
(2, 2, NULL, '49820', '20130619/51c161d973ca6.mp3'),
(3, 2, NULL, '49820', '20130619/51c161e959f2e.mp3'),
(4, 2, NULL, '49820', '20130619/51c161fccc6f6.mp3'),
(5, 1, NULL, '285771', '20130619/51c1642593b58.png'),
...
CREATE TABLE IF NOT EXISTS `oa_topic` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='主题id' AUTO_INCREMENT=5 ;

--
-- 转存表中的数据 `oa_topic`
--

INSERT INTO `oa_topic` (`id`, `app_id`, `type`, `pid`, `user_id`, `phase`, `content`, `voice`, `pic`, `time`, `new_comids`, `status`) VALUES
(2, 1, 1, 0, 1, NULL, 'helloWorld', 6, 5, 1371628581, '10,9', 0),
(3, 1, 1, 0, 1, NULL, 'helloWorld', 6, 5, 1371628581, '12,11', 0),
(4, 1, 1, 0, 1, NULL, 'helloWorld', 6, 5, 1371628581, '14,13', 0);
...
(1, 1, 0, 'admin1', '管理员', 'e10adc3949ba59abbe56e057f20f883e', 1371695572, '192.168.1.116', 11, NULL, NULL, 'aaa.pic', 0, 0, 0, NULL),
